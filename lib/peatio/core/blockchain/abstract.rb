module Peatio #:nodoc:
  module Core
    module Blockchain #:nodoc:
      ...
      # @example
      #
      #   class MyBlockchain < Peatio::Core::Abstract::Blockchain
      ...
      #   Peatio::Core::Blockchain.registry[:my_blockchain] = MyBlockchain.new
      #
      # @author
      ...
      class Abstract
        ...
        #   Peatio::Core::Blockchain.registry[:my_blockchain] = MyBlockchain.new(custom_features)
        def initialize(*)
          abstract_method
        end
        ...
        # @return [Peatio::Core::Block] the block object.
        ...
        def load_balance_of_address!(address, currency_id)
          raise Peatio::Core::Blockchain::UnavailableAddressBalanceError
        end
