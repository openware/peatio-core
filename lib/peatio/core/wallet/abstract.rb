module Peatio
  module Core
    module Wallet
      ...
      # @example
      #
      #   class MyWallet < Peatio::Core::Abstract::Wallet
      ...
      #   Peatio::Core::Wallet.registry[:my_wallet] = MyWallet.new
      #
      # @author
      ...
      class Abstract
        ...
        #   Peatio::Core::Wallet.registry[:my_wallet] = MyWallet.new(custom_features)
        def initialize(*)
          abstract_method
        end
        ...
        #
        # @raise [Peatio::Core::Blockchain::ClientError] if error was raised
        #   on wallet API call.
        #
        # @example
        ...
        # @abstract
        #
        # @param [Peatio::Core::Transaction] transaction transaction with defined
        ...
        #
        # @return [Peatio::Core::Transaction] transaction with updated hash.
        #
        # @raise [Peatio::Core::Blockchain::ClientError] if error was raised
        #   on wallet API call.
        ...
        #
        # @raise [Peatio::Core::Blockchain::ClientError,Peatio::Core::Blockchain::UnavailableAddressBalanceError]
        ...
        def load_balance!
          raise Peatio::Core::Wallet::UnavailableAddressBalanceError
        end
        ...
        #
        # @param [Peatio::Core::Transaction] deposit_transaction transaction which
        # describes received deposit.
        #
        # @param [Array<Peatio::Core::Transaction>] spread_transactions result of deposit
        # spread between wallets.
        #
        # @return [Array<Peatio::Core::Transaction>] transaction created for
